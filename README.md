...
### **Coding in Markdown reflection:** <br>
**Situation:** As part of the Work Readiness Training at Cape Peninsula University of Technology, we were assigned to code our CV's in GitHub using Markdown and also include our mock interview video. The purpose of using Markdown in this project was to learn how to create well-structured and readable web content using a simple text-based formatting language. It is commonly used by developers on platforms like GitHub to document projects, create portfolios, and organize information clearly.<br>
**Task:** My task was to learn how to use Markdown syntax to create and structure my digital portfolio. This included formatting headings, adding links, embedding media, and organizing information in a clear and readable way.<br>
**Action:** I started by researching Markdown syntax and how it works. I started by coding my CV using the different syntax characters and formats. I then structured my portfolio so that sections such as my CV, mock interview video, and reflections were clearly organized and easy to read.<br>
...
### **Mock Interview video experience reflection:** <br>
...
**Task:** My task was to record a mock interview video and present myself professionally. I had to answer interview questions using the STAR method and explain my technical skills and projects. The goal was to practice communicating my abilities clearly while demonstrating confidence and professionalism.<br>
**Action:** To prepare, I went through the list of interview questions we were provided with, researched the different types of questions, and then picked one question from each section. I then wrote down my questions and responses and practiced using the STAR method. I went through the guidelines clearly and during the interview I focused on speaking clearly, maintaining professionalism and eye-contact, and providing thoughtful responses. After a few attempts I managed to get it right! Uploading the video was a bit difficult as the file size was over the limit so I had to reduce the resolution.<br>
...
### **Using GitHub Pages reflection:** <br>
**Situation:** As part of the Work Readiness Training at Cape Peninsula University of Technology, we were required to create a digital portfolio to showcase our work readiness activities. This included presenting our CV, mock interview video, and reflections using Markdown. To achieve this, we used GitHub Pages to publish and host our portfolio so that it could be accessed through a public web link.<br>
**Task:** My task was to deploy my portfolio using GitHub Pages so that it could be accessed through a public link. This required connecting my GitHub repository to GitHub Pages and ensuring that my Markdown content was displayed correctly as a website.<br>
**Action:** I followed the instructions that were provided and created a GitHub repository, uploaded my CV files, and enabled GitHub Pages to publish the site. I then later added more content for my portfolio and ensured that it included my CV, mock interview video, and reflections, and that the content was properly formatted using Markdown.<br>
